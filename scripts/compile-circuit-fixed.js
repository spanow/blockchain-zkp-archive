...
async function main() {
    try {
        ...
        // Notez l'ajout de l'option -l pour indiquer le chemin d'inclusion
        console.log('Étape 1: Compile le circuit avec Circom');
        execSync('circom circuits/FileAccessVerifier.circom --r1cs --wasm --sym -o build/circuits -l node_modules');
        ...
        // Générer les paramètres "powers of tau"
        ...
        // Génération des clés de vérification
